...
@click.away="isOpen = false">
    ...
    <div class="z-50 fixed" x-ref="content">
        <div x-show="isOpen" x-cloak style="display:none;" class="p-2 bg-white border border-gray-200 rounded-2xl shadow-lg dark:border-neutral-800 dark:bg-neutral-900 w-40">
