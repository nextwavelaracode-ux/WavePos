...
<div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-neutral-800 dark:bg-neutral-800/20 sm:p-6">
    ...
    <div class="border-gary-200 my-6 overflow-hidden rounded-2xl border bg-gray-50 px-4 py-6 dark:border-neutral-800 dark:bg-neutral-900 sm:px-6">
        ...
        @foreach($countriesList as $country)
            <div class="flex items-center justify-between">
                ...
                <div class="flex w-full max-w-[140px] items-center gap-3">
                    <div class="relative block h-2 w-full max-w-[100px] rounded-sm bg-gray-200 dark:bg-neutral-800">
                        <div 
