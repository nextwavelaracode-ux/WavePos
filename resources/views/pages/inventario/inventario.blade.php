    ...
    <div id="inventario-root" x-data="{
        ...
        <div class="mb-6 grid md:grid-cols-4 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 shadow-2xs rounded-xl overflow-hidden">
            ...
            <div class="block p-4 md:p-5 relative bg-white dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:h-full before:border-s before:border-gray-200 dark:before:border-neutral-700 first:before:hidden">
                <div class="flex flex-col lg:flex-row gap-y-3 gap-x-5">
                    <svg class="shrink-0 size-5 text-gray-400 dark:text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4"/></svg>
                    <div class="grow">
                        <p class="text-xs uppercase font-medium text-gray-800 dark:text-neutral-200">Total Productos</p>
                        <h3 class="mt-1 text-xl sm:text-2xl font-semibold text-brand-600 dark:text-brand-500">{{ $totalProductos }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Registrados en sistema</p>
                    </div>
                </div>
            </div>
            ...
            <div class="block p-4 md:p-5 relative bg-white dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:h-full before:border-s before:border-gray-200 dark:before:border-neutral-700 first:before:hidden">
                <div class="flex flex-col lg:flex-row gap-y-3 gap-x-5">
                    ...
                    <div class="grow">
                        <p class="text-xs uppercase font-medium text-gray-800 dark:text-neutral-200">Stock Bajo</p>
                        <h3 class="mt-1 text-xl sm:text-2xl font-semibold text-orange-600 dark:text-orange-500">{{ $stockBajo }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Requieren atención</p>
                    </div>
                </div>
            </div>
            ...
            <div class="block p-4 md:p-5 relative bg-white dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:h-full before:border-s before:border-gray-200 dark:before:border-neutral-700 first:before:hidden">
                <div class="flex flex-col lg:flex-row gap-y-3 gap-x-5">
                    <svg class="shrink-0 size-5 text-gray-400 dark:text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"/></svg>
                    <div class="grow">
                        <p class="text-xs uppercase font-medium text-gray-800 dark:text-neutral-200">Sin Stock</p>
                        <h3 class="mt-1 text-xl sm:text-2xl font-semibold text-red-600 dark:text-red-500">{{ $sinStock }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Agotados</p>
                    </div>
                </div>
            </div>
            ...
            <div class="block p-4 md:p-5 relative bg-white dark:bg-neutral-800 hover:bg-gray-50 dark:hover:bg-neutral-700 transition before:absolute before:top-0 before:start-0 before:w-full before:h-px md:before:h-full before:border-s before:border-gray-200 dark:before:border-neutral-700 first:before:hidden">
                <div class="flex flex-col lg:flex-row gap-y-3 gap-x-5">
                    <svg class="shrink-0 size-5 text-gray-400 dark:text-neutral-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <div class="grow">
                        <p class="text-xs uppercase font-medium text-gray-800 dark:text-neutral-200">Stock Normal</p>
                        <h3 class="mt-1 text-xl sm:text-2xl font-semibold text-emerald-600 dark:text-emerald-500">{{ $totalProductos - $stockBajo - $sinStock }}</h3>
                        <p class="mt-1 text-sm text-gray-500 dark:text-neutral-400">Niveles óptimos</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="w-full max-w-sm min-w-[200px]" x-data="{
                ...
                <div class="relative mt-2">
                    <div class="absolute top-1 left-1 flex items-center">
                        <button type="button" @click="dropdownOpen = !dropdownOpen" class="rounded border border-transparent py-1 px-1.5 text-center flex items-center text-sm transition-all text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-neutral-800">
                        ...
                        <div class="h-6 border-l border-slate-200 dark:border-neutral-700 ml-1"></div>
                        
                        <div x-show="dropdownOpen" x-transition.opacity class="min-w-[200px] overflow-hidden absolute left-0 top-full mt-2 bg-white dark:bg-neutral-800 border border-slate-200 dark:border-neutral-700 rounded-md shadow-lg z-50" style="display:none;">
                            <ul class="max-h-64 overflow-y-auto py-1">
                                <li @click="setCategoria('')" class="px-4 py-2 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-neutral-700 text-sm cursor-pointer whitespace-nowrap">Todas las categorías</li>
                                @foreach($categorias as $cat)
                                <li @click="setCategoria('{{ addslashes($cat->nombre) }}')" class="px-4 py-2 text-slate-600 dark:text-gray-300 hover:bg-slate-50 dark:hover:bg-neutral-700 text-sm cursor-pointer whitespace-nowrap">{{ $cat->nombre }}</li>
                                @endforeach
                            </ul>
                        </div>
                    </div>
                    ...
                    <input
                        x-model="searchTerm"
                        type="text"
                        class="w-full bg-transparent placeholder:text-slate-400 text-slate-700 dark:text-white text-sm border border-slate-200 dark:border-neutral-700 rounded-md pl-32 pr-24 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 dark:hover:border-gray-600 shadow-sm focus:shadow"
            ...
            <div class="sm:w-auto mt-0">
                <select x-model="filterStock" class="block w-full rounded-md border border-slate-200 bg-transparent py-2.5 px-3 text-sm text-slate-700 shadow-sm focus:border-slate-400 focus:ring-0 dark:border-neutral-700 dark:text-gray-300">
                                ...
                                <td class="px-5 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        ...
                                        <a href="{{ route('inventario.movimientos', ['producto_id' => $producto->id]) }}"
                                            class="inline-flex items-center gap-1 rounded-lg border border-gray-200 bg-white px-2.5 py-1.5 text-xs font-medium text-gray-600 hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-400 transition-colors"
                ...
                <form action="{{ route('inventario.entrada') }}" method="POST" id="form-entrada">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <select name="producto_id" required class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700">
                        ...
                        <div>
                            ...
                            <select name="proveedor_id" class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700">
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="number" name="cantidad" min="1" required class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="0">
                            </div>
                            {{-- Precio de compra --}}
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Precio de Compra</label>
                                <input type="number" name="precio_compra" min="0" step="0.01" class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="0.00">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="date" name="fecha" value="{{ date('Y-m-d') }}" required class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700">
                            </div>
                            {{-- Factura --}}
                            <div>
                                <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Nro. Factura</label>
                                <input type="text" name="numero_factura" class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="FAC-000">
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="observaciones" rows="2" class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="Notas adicionales..."></textarea>
                        </div>
                    </div>

                    <div class="mt-8 flex justify-end gap-3 border-t border-gray-100 dark:border-neutral-800 pt-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <select name="motivo" required class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700">
        ...
        <div x-show="showAjuste" x-transition:enter="transition ease-out duration-200"
            ...
            <div @click.outside="showAjuste = false"
                class="no-scrollbar relative w-full max-w-lg overflow-y-auto rounded-3xl bg-white p-6 dark:bg-neutral-900 mx-4 max-h-[92vh] lg:p-10">
                ...
                <form action="{{ route('inventario.ajuste') }}" method="POST" id="form-ajuste">
                    ...
                    <div class="space-y-5">
                        <div class="rounded-xl bg-gray-50 dark:bg-neutral-800/20 px-4 py-3">
                        ...
                        <div>
                            ...
                            <input type="number" name="stock_nuevo" id="ajuste-stock-nuevo" min="0" required class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="0">
                        </div>

                        <div>
                            <label class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-300">Observaciones</label>
                            <textarea name="observaciones" rows="2" class="w-full rounded-xl border border-gray-200 bg-transparent px-4 py-2.5 text-sm text-gray-800 dark:text-white focus:border-brand-500 focus:ring-0 dark:border-neutral-700" placeholder="Motivo del ajuste..."></textarea>
                        </div>
                    </div>
        ...
        <script>
            function confirmarEntrada() {
                ...
                setTimeout(() => {
                    window.Confirm.show(
                        '¿Registrar entrada?',
                        'Se aumentará el stock del producto seleccionado.',
                        'Sí, registrar',
                        'Cancelar',
            ...
            function confirmarSalida() {
                ...
                setTimeout(() => {
                    window.Confirm.show(
                        '¿Registrar salida?',
                        'Se reducirá el stock del producto seleccionado.',
                        'Sí, registrar',
                        'Cancelar',
            ...
            function confirmarAjuste() {
                ...
                setTimeout(() => {
                    window.Confirm.show(
                        '¿Ajustar inventario?',
                        `Stock de "${nombre}" cambiará de ${stockActual} a ${stockNuevo}.`,
                        'Sí, ajustar',
                        'Cancelar',
                        () => { document.getElementById('form-ajuste').submit(); },
                        () => { mainEl._x_dataStack[0].showAjuste = true; },
                        { okButtonBackground: '#465fff' }
                    );
                }, 200);
            }
        </script>
