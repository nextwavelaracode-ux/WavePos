        ...
        <div class="overflow-x-auto">
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-neutral-800">
                    ...
                    <tr class="hover:bg-gray-50/50 dark:hover:bg-neutral-800/10 transition-colors" :class="selectedIds.includes({{ $proveedor->id }}) ? 'bg-brand-50 dark:bg-brand-500/5' : ''">
        ...
        <div @click.outside="showCreate = false"
            ...
            <form action="{{ route('inventario.proveedores.store') }}" method="POST">
                    ...
                    <div class="sm:col-span-2 lg:col-span-3 pt-2">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <div class="relative">
                                ...
                                <div class="block h-6 w-10 rounded-full bg-gray-300 dark:bg-neutral-700 transition"></div>
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <button type="button" @click="showCreate = false" class="rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-300 dark:hover:bg-white/[0.03] transition-colors">
                        Cancelar
                    </button>
    ...
    <div x-show="showEdit" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
        ...
        <div @click.outside="showEdit = false"
            ...
            <form :action="`/inventario/proveedores/${editData.id}`" method="POST">
                    ...
                    <div class="sm:col-span-2 lg:col-span-3 pt-2">
                        <label class="flex items-center gap-3 cursor-pointer">
                            <div class="relative">
                                ...
                                <div class="block h-6 w-10 rounded-full bg-gray-300 dark:bg-neutral-700 transition" :class="editData.estado ? 'bg-brand-500 dark:bg-brand-500' : ''"></div>
                ...
                <div class="mt-8 flex justify-end gap-3">
                    <button type="button" @click="showEdit = false" class="rounded-xl border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-neutral-700 dark:bg-neutral-800 dark:text-gray-300 dark:hover:bg-white/[0.03] transition-colors">
                        Cancelar
                    </button>
                    <button type="submit" class="rounded-xl bg-brand-500 px-5 py-2.5 text-sm font-medium text-white hover:bg-brand-600 transition-colors">
