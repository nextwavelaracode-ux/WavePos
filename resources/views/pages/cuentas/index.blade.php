        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/[0.05] dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Total por Cobrar</p>
                        <h3 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">${{ number_format($kpis['total_deuda'], 2) }}</h3>
                    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/[0.05] dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Monto Vencido</p>
                        <h3 class="mt-1 text-2xl font-bold text-red-600 dark:text-red-400">${{ number_format($kpis['total_vencido'], 2) }}</h3>
                    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/[0.05] dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Clientes Deudores</p>
                        <h3 class="mt-1 text-2xl font-bold text-gray-800 dark:text-white">{{ $kpis['clientes_con_deuda'] }}</h3>
                    </div>
            ...
            <div class="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-white/[0.05] dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Cobros del Mes</p>
                        <h3 class="mt-1 text-2xl font-bold text-emerald-600 dark:text-emerald-400">${{ number_format($kpis['cobros_mes'], 2) }}</h3>
                    </div>
            ...
            <div class="p-5 border-b border-gray-100 dark:border-white/[0.05] flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <form action="{{ route('cuentas.index') }}" method="GET" class="flex flex-wrap gap-3">
                    ...
                    <select name="estado" onchange="this.form.submit()"
                        class="h-10 rounded-xl border border-gray-200 bg-gray-50 px-4 text-sm focus:border-brand-500 focus:ring-0 dark:border-white/[0.1] dark:bg-white/[0.03] dark:text-white">
